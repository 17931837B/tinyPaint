...
void LoadTexture()
{
    ...
    glClearColor(1.0f, 0.0f, 0.0f, 1.0f); // フレームバッファをクリアするための色を赤に設定
    ...
    // 修正箇所: フレームバッファのクリア後、ウィンドウの背景色を再度設定し直す
    // これをしないと、display()でのglClearが赤でクリアしてしまう
...
int main(int argc, char **argv)
{
    ...
    window = glfwCreateWindow(600, 900, "OpenGL Exercise 01", NULL, NULL); 
    if (!window)
    {
